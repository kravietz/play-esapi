...
/*
 This simple  model contains one useful field - title - that can be edited
 by the user. The other field isAdmin is **not** intended to be edited
 by users and it serves as demonstration of mass assignment attack. Identifier
